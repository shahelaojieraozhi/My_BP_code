...
def loss_calculate(pre, label, opt):
    if opt.loss_func == 'mse':
        ...
        a = F.mse_loss(pre, label) - torch.tensor(25)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--describe", type=str, default='L2+Hinge_loss', help="describe for this model")
    ...
    parser.add_argument('--loss_func', type=str, default='L2_Hinge_loss',
                        choices=('SmoothL1Loss', 'mse', 'bp_bucketing_loss', 'HuberLoss', 'L2+Hinge'),
