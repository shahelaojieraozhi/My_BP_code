...
ref: https://github.com/dthiagarajan/ptb-xl-research/blob/master/core/models/resnet.py
"""
import torch
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_input_channels=3, num_classes=1000,
                 ...
                 replace_stride_with_dilation=None, norm_layer=nn.BatchNorm1d, layer_mixup=False):
...
def main():
    ...
    dummy = torch.randn([10, 1000, 1])  # PTB-XL
    # dummy = torch.transpose(dummy, 1, 2)
